  ...
  return (
    <div className='flex justify-center items-center bg-white h-screen w-screen bg-cover  ' style={{ backgroundImage: `url(${AuthImg})` }}>
        <div className='flex flex-col items-center px-3 py-6 bg-slate-50 rounded-md w-60'>
            ...
            <input type='email' placeholder='Email' name='email' className='p-2 text-sm m-2 rounded-md w-full border border-orange-400 hover:scale-105 transition-transform duration-75 ease-in-out focus:outline-none' required value={formData.email} onChange={handleInput}/>
            <input type='password' placeholder='Password' name='password' className='p-2 text-sm m-2 rounded-md w-full border border-orange-400 hover:scale-105 transition-transform duration-75 ease-in-out focus:outline-none' required value={formData.password} onChange={handleInput}/>
